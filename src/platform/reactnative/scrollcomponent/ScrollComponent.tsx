...
export default class ScrollComponent extends BaseScrollComponent {
  ...
  public componentDidMount(): void {
    this._dimensionsChangeSubscription = Dimensions.addEventListener(
      'change',
      debounce(({ window }: any) => {
  ...
  public render(): JSX.Element {
    ...
    const renderContentContainer = this.props.renderContentContainer
      ...
      : ScrollComponent._defaultContainer;
    const contentContainerProps = {
      ...
      windowSize:
        (this.props.isHorizontal ? this._width : this._height) +
        this.props.renderAheadOffset,
    };
    //TODO:Talha
    // const {
    //     useWindowScroll,
  ...
  private _onScroll = (event?: any): void => {
    if (event) {
      ...
      this._offset = this.props.isHorizontal
        ? contentOffset.x
        : contentOffset.y;

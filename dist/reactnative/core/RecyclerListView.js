...
var RecyclerListView = /** @class */ (function (_super) {
    ...
    function RecyclerListView(props, context) {
        ...
        _this._endStartReachedCalled = false;
        _this._endEndReachedCalled = false;
        ...
        _this._processOnEdgeReached = function () {
            ...
            if (!_this._getOnEdgeReachedCalled() && _this._virtualRenderer && (_this.props.onEndReached || _this.props.onStartReached)) {
                ...
                if (viewabilityTracker) {
                    var windowBound = _this.props.isHorizontal ? virtualLayout.width - _this._layout.width : virtualLayout.height - _this._layout.height;
    ...
    RecyclerListView.prototype._checkAndChangeLayouts = function (newProps, forceFullRender) {
        ...
        if (this.props.layoutProvider !== newProps.layoutProvider || this.props.isHorizontal !== newProps.isHorizontal) {
            ...
            var onStartReachedCalled = this._onStartReachedCalled;
            if (newProps.dataProvider.getSize() === this.props.dataProvider.getSize()) {
                if (this._onStartReachedCalled) {
                    this._endStartReachedCalled = true;
                }
                else if (this._onEndReachedCalled) {
                    this._endEndReachedCalled = true;
                }
            }
            var layoutManager = this._virtualRenderer.getLayoutManager();
            if (layoutManager) {

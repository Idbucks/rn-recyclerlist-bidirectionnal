...
var StickyObject = /** @class */ (function (_super) {
    ...
    StickyObject.prototype.renderCompat = function () {
        ...
        var content = (React.createElement(react_native_1.Animated.View, { style: containerStyle }, this.stickyVisibility ? this._renderSticky() : null));
        if (this.props.renderContainer) {

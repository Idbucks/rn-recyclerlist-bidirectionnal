...
var ScrollComponent = /** @class */ (function (_super) {
    ...
    function ScrollComponent(args) {
        ...
        _this._height = 0;
        _this._width = 0;
        _this._debouncedOnWindowResize = debounce(_this._onWindowResize, 100);
        return _this;
    }
    ...
    ScrollComponent.prototype.render = function () {
        ...
        var headerFooterWrapperStyle = this.props.isHorizontal ? {
        ...
        return (React.createElement(Scroller, __assign({ ref: function (scrollView) { return _this._scrollViewRef = scrollView; } }, this.props, { horizontal: this.props.isHorizontal, onScroll: this._onScroll, onSizeChanged: this._onSizeChanged }),
            this.props.renderHeader && (React.createElement("div", { style: headerFooterWrapperStyle }, this.props.renderHeader())),
            React.createElement("div", { style: {
                    height: this.props.contentHeight,
                    width: this.props.contentWidth,
                } }, this.props.children),
            this.props.renderFooter && (React.createElement("div", { style: headerFooterWrapperStyle }, this.props.renderFooter()))));
    };
